...
public class PassportBook {
    ...
    public void open(Player viewer) {
        ...
        String ministry = config.getString(path + "ministry", "Министерство юстиции");
        ...
        Component page5 = Component.text()
                ...
                .append(Component.text("  Министерство: ", NamedTextColor.DARK_GREEN))
